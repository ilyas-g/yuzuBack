...
export interface ApiPlayerPlayer extends Schema.CollectionType {
  ...
  attributes: {
    ...
    idStartGG: Attribute.String & Attribute.Required & Attribute.Unique;
...
export interface ApiSimplepageSimplepage extends Schema.SingleType {
  collectionName: 'simplepages';
  info: {
    singularName: 'simplepage';
    pluralName: 'simplepages';
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::simplepage.simplepage': ApiSimplepageSimplepage;
    }
  }
}
